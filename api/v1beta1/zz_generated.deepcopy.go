...
func (in *CruiseControlConfig) DeepCopyInto(out *CruiseControlConfig) {
	*out = *in
	...
	if in.CruiseControlOperatonSpec != nil {
		in, out := &in.CruiseControlOperatonSpec, &out.CruiseControlOperatonSpec
		*out = new(CruiseControlOperatonSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Resources != nil {
		in, out := &in.Resources, &out.Resources
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CruiseControlOperatonSpec) DeepCopyInto(out *CruiseControlOperatonSpec) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CruiseControlOperatonSpec.
func (in *CruiseControlOperatonSpec) DeepCopy() *CruiseControlOperatonSpec {
	if in == nil {
		return nil
	}
	out := new(CruiseControlOperatonSpec)
