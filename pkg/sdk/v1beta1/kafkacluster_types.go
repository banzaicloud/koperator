...
type KafkaClusterSpec struct {
	...
	// Envs defines environment variables for the Kafka broker Pods
	// Using the "+" prefix appends the variable to the default generated by the operator
...
type BrokerConfig struct {
	...
	// Envs defines environment variables for the Kafka broker Pods.
	// Using the "+" prefix appends the variable for the ones defined in cluser level or by the operator
	Envs []corev1.EnvVar `json:"envs,omitempty"`
}
