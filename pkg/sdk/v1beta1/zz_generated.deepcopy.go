...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ListenerStatusMap) DeepCopyInto(out *ListenerStatusMap) {
	{
		in := &in
		*out = make(ListenerStatusMap, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ListenerStatusMap.
func (in ListenerStatusMap) DeepCopy() ListenerStatusMap {
	if in == nil {
		return nil
	}
	out := new(ListenerStatusMap)
	in.DeepCopyInto(out)
	return *out
}
