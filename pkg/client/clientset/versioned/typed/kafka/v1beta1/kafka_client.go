...
// KafkaV1beta1Client is used to interact with features provided by the kafka.banzaicloud.io group.
type KafkaV1beta1Client struct {
	restClient rest.Interface
}

func (c *KafkaV1beta1Client) KafkaClusters(namespace string) KafkaClusterInterface {
