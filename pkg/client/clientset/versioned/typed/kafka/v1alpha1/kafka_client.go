...
// KafkaV1alpha1Client is used to interact with features provided by the kafka.banzaicloud.io group.
type KafkaV1alpha1Client struct {
	restClient rest.Interface
}

func (c *KafkaV1alpha1Client) KafkaTopics(namespace string) KafkaTopicInterface {
	return newKafkaTopics(c, namespace)
}

func (c *KafkaV1alpha1Client) KafkaUsers(namespace string) KafkaUserInterface {
