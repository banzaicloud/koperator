...
import (
	...
	kafkav1beta1 "github.com/banzaicloud/kafka-operator/api/kafka/v1beta1"
	...
	v1beta1 "github.com/banzaicloud/kafka-operator/pkg/client/listers/kafka/v1beta1"
...
type KafkaClusterInformer interface {
	...
	Lister() v1beta1.KafkaClusterLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.KafkaV1beta1().KafkaClusters(namespace).List(options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.KafkaV1beta1().KafkaClusters(namespace).Watch(options)
			},
		},
...
func (f *kafkaClusterInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&kafkav1beta1.KafkaCluster{}, f.defaultInformer)
}

func (f *kafkaClusterInformer) Lister() v1beta1.KafkaClusterLister {
	return v1beta1.NewKafkaClusterLister(f.Informer().GetIndexer())
}
